...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1, last_activation='sigmoid', pretrained=False, bias=True):
        super(ResNet, self).__init__()
        self.in_planes = 16

        self.conv1 = nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1, bias=True)
        # self.conv1 = nn.Conv1d(17, 16, kernel_size=3, stride=1, padding=1, bias=True)
    ...
    def forward(self, x):
        ...
        # out = F.avg_pool1d(out,kernel_size=1)
